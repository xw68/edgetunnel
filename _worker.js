...
let proxyIP = 'cdn-all.xn--b6gac.eu.org';// 小白勿动，该地址并不影响你的网速，这是给CF代理使用的。'cdn.xn--b6gac.eu.org, cdn-all.xn--b6gac.eu.org'

let sub = '';// 避免项目被滥用，现已取消内置订阅器 原来是：没有显示原版内容内置优选订阅生成器，可自行搭建 https://github.com/cmliu/WorkerVless2sub就是submake那个
